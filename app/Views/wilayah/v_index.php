                ...
                <tbody>
                    ...
                    foreach ($wilayah as $key => $value) { ?>
                        <tr class="text-center">
                            ...
                            <td>
                                <a href="<?= base_url('Wilayah/Edit/' . $value['id_wilayah']) ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                <a href="<?= base_url('Wilayah/Delete/' . $value['id_wilayah']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data Wilayah ?')"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
