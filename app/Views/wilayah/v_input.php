    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= old('nama_wilayah') ?>" class="form-control" name="nama_wilayah">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= old('warna') ?>" class="form-control  my-colorpicker1" name="warna">
            ...
            <div class="form-group">
                ...
                <textarea name="geojson" rows="10" class="form-control"><?= old('geojson') ?></textarea>
