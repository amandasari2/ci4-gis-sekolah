    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?= $user['nama_user'] ?>" class="form-control" name="nama_user" placeholder="Masukkan Nama User">
                <p class="text-danger"><?= isset($errors['nama_user']) == isset($errors['nama_user']) ? validation_show_error('nama_user') : '' ?></p>
            </div>

            <div class="form-group">
                <label for="email">E - mail</label>
                <input type="text" value="<?= $user['email'] ?>" class="form-control" name="email" placeholder="Masukkan E - mail">
                <p class="text-danger"><?= isset($errors['email']) == isset($errors['email']) ? validation_show_error('email') : '' ?></p>
            </div>

            <div class="form-group">
                <label for="password">Password</label>
                <input type="text" value="<?= $user['password'] ?>" class="form-control" name="password" placeholder="Masukkan Password">
